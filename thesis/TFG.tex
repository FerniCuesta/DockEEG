...
% Añadir el paquete enumitem para permitir opciones como [noitemsep] en itemize
\usepackage{enumitem}

% Evitar cortes de palabras y saltos de linea
% \hyphenpenalty=10000
\exhyphenpenalty=10000

% Permitir varias figuras en una misma página
...
\usepackage[colorlinks,urlcolor=blue,linkcolor=,breaklinks=true]{hyperref}
...
\input{capitulos/acro_list}

\input{capitulos/01_Introducción}
%
\input{capitulos/02_Gestion del proyecto}
%
...
%
\input{capitulos/06_Conclusiones y Trabajo Futuro}
%
