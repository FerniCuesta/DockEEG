...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/single-node_ubuntu_\textit{Docker}_time.png}
    \caption{Tiempo de ejecución en un único nodo con contenedores de Ubuntu (CPU).}
    \label{fig:single-node_ubuntu_\textit{Docker}_time}
\end{figure}

En la tabla \ref{tab:single-node_ubuntu_\textit{Docker}} se presentan los tiempos de ejecución y la variación porcentual respecto a una hebra.
...
\begin{table}[ht]
    ...
    \label{tab:single-node_ubuntu_\textit{Docker}}
\end{table}
...
En la figura \ref{fig:single-node_ubuntu_\textit{Podman}_time} se muestra el tiempo de ejecución para la configuración de CPU en un único nodo con contenedores de Ubuntu gestionados por \textit{Podman}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/single-node_ubuntu_\textit{Podman}_time.png}
    \caption{Tiempo de ejecución en un único nodo con contenedores de Ubuntu gestionados por \textit{Podman} (CPU).}
    \label{fig:single-node_ubuntu_\textit{Podman}_time}
\end{figure}

En la tabla \ref{tab:single-node_ubuntu_\textit{Podman}} se presentan los tiempos de ejecución y la variación porcentual respecto a una hebra.
...
\begin{table}[ht]
    ...
    \label{tab:single-node_ubuntu_\textit{Podman}}
\end{table}
...
En la figura \ref{fig:single-node_ubuntu_\textit{Docker}_gpu_time} se muestra el tiempo de ejecución para la configuración de CPU + GPU en un único nodo con contenedores de Ubuntu.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/single-node_ubuntu_\textit{Docker}_gpu_time.png}
    \caption{Tiempo de ejecución en un único nodo con contenedores de Ubuntu (CPU + GPU).}
    \label{fig:single-node_ubuntu_\textit{Docker}_gpu_time}
\end{figure}

En la tabla \ref{tab:single-node_ubuntu_\textit{Docker}_gpu} se presentan los tiempos de ejecución y la variación porcentual respecto a una hebra.
...
\begin{table}[ht]
    ...
    \label{tab:single-node_ubuntu_\textit{Docker}_gpu}
\end{table}
...
En la figura \ref{fig:single-node_ubuntu_\textit{Podman}_gpu_time} se muestra el tiempo de ejecución para la configuración de CPU + GPU en un único nodo con contenedores de Ubuntu gestionados por \textit{Podman}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/single-node_ubuntu_\textit{Podman}_gpu_time.png}
    \caption{Tiempo de ejecución en un único nodo con contenedores de Ubuntu gestionados por \textit{Podman} (CPU + GPU).}
    \label{fig:single-node_ubuntu_\textit{Podman}_gpu_time}
\end{figure}

En la tabla \ref{tab:single-node_ubuntu_\textit{Podman}_gpu} se presentan los tiempos de ejecución y la variación porcentual respecto a una hebra.
...
\begin{table}[ht]
    ...
    \label{tab:single-node_ubuntu_\textit{Podman}_gpu}
\end{table}
...
\begin{table}[ht]
    ...
    \label{tab:single-node_windows_\textit{Docker}_time}
\end{table}
...
En la figura \ref{fig:single-node_windows_\textit{Podman}_time} se muestra el tiempo de ejecución para la configuración de CPU en un único nodo con \textit{Podman} en Windows.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/single-node_windows_\textit{Podman}_time.png}
    \caption{Tiempo de ejecución en un único nodo con \textit{Podman} en Windows (CPU).}
    \label{fig:single-node_windows_\textit{Podman}_time}
\end{figure}

En la tabla \ref{tab:single-node_windows_\textit{Podman}_time} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
% En la figura \ref{fig:single-node_windows_\textit{Docker}_gpu_time} se muestra el tiempo de ejecución para la configuración de CPU + GPU en un único nodo con \textit{Docker} en Windows.

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.8\textwidth]{imagenes/cap5/single-node_windows_\textit{Docker}_gpu_time.png}
%     \caption{Tiempo de ejecución en un único nodo con \textit{Docker} en Windows (CPU + GPU).}
%     \label{fig:single-node_windows_\textit{Docker}_gpu_time}
% \end{figure}

% En la tabla \ref{tab:single-node_windows_\textit{Docker}_gpu_time} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.

\subsection{Ejecución en contenedores de Mac}
\subsubsection{CPU}

En la figura \ref{fig:single-node_mac_\textit{Docker}_time} se muestra el tiempo de ejecución para la configuración de CPU en un único nodo con \textit{Docker} en Mac.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/single-node_mac_\textit{Docker}_time.png}
    \caption{Tiempo de ejecución en un único nodo con \textit{Docker} en Mac (CPU).}
    \label{fig:single-node_mac_\textit{Docker}_time}
\end{figure}

En la tabla \ref{tab:single-node_mac_\textit{Docker}_time} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
\begin{table}[ht]
    ...
    \label{tab:single-node_mac_\textit{Docker}_time}
\end{table}
...
En la figura \ref{fig:single-node_mac_\textit{Podman}_time} se muestra el tiempo de ejecución para la configuración de CPU en un único nodo con \textit{Podman} en Mac.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/single-node_mac_\textit{Podman}_time.png}
    \caption{Tiempo de ejecución en un único nodo con \textit{Podman} en Mac (CPU).}
    \label{fig:single-node_mac_\textit{Podman}_time}
\end{figure}

En la tabla \ref{tab:single-node_mac_\textit{Podman}_time} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
\begin{table}[ht]
    ...
    \label{tab:single-node_mac_\textit{Podman}_time}
\end{table}
...
En la figura \ref{fig:multi-node_ubuntu_\textit{Docker}_time} se muestra el tiempo de ejecución para la configuración de CPU en un entorno multinodo con contenedores de Ubuntu.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/multi-node_ubuntu_\textit{Docker}_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores de Ubuntu (CPU) en entorno multinodo.}
    \label{fig:multi-node_ubuntu_\textit{Docker}_time}
\end{figure}

En la tabla \ref{tab:multi-node_ubuntu_\textit{Docker}} se presentan los tiempos de ejecución y la variación porcentual respecto a una hebra.
...
\begin{table}[ht]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \hline
    \end{tabular}
    \caption{Tiempos de ejecución y variación porcentual respecto a un nodo en entorno multinodo con contenedores de Ubuntu (CPU).}
    \label{tab:multi-node_ubuntu_\textit{Docker}}
\end{table}
...
En la figura \ref{fig:multi-node_ubuntu_\textit{Podman}} se muestra el tiempo de ejecución para la configuración de CPU en un entorno multinodo con contenedores de \textit{Podman}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/multi-node_ubuntu_\textit{Podman}_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores de \textit{Podman} (CPU) en entorno multinodo.}
    \label{fig:multi-node_ubuntu_\textit{Podman}}
\end{figure}

En la tabla \ref{tab:multi-node_ubuntu_\textit{Podman}} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
En la figura \ref{fig:multi-node_ubuntu_\textit{Docker}_gpu_time} se muestra el tiempo de ejecución para la configuración de CPU + GPU en un entorno multinodo con contenedores de Ubuntu.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/multi-node_ubuntu_\textit{Docker}_gpu_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores de Ubuntu (CPU + GPU) en entorno multinodo.}
    \label{fig:multi-node_ubuntu_\textit{Docker}_gpu_time}
\end{figure}

En la tabla \ref{tab:multi-node_ubuntu_\textit{Docker}_gpu} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
\begin{table}[ht]
    ...
    \label{tab:multi-node_ubuntu_\textit{Docker}_gpu}
\end{table}
...
En la figura \ref{fig:multi-node_ubuntu_\textit{Podman}_gpu_time} se muestra el tiempo de ejecución para la configuración de CPU + GPU en un entorno multinodo con contenedores de \textit{Podman}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/multi-node_ubuntu_\textit{Podman}_gpu_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores de \textit{Podman} (CPU + GPU) en entorno multinodo.}
    \label{fig:multi-node_ubuntu_\textit{Podman}_gpu_time}
\end{figure}

En la tabla \ref{tab:multi-node_ubuntu_\textit{Podman}_gpu} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
En la figura \ref{fig:multi-node_windows_\textit{Podman}_time} se muestra el tiempo de ejecución para la configuración de CPU en un entorno multinodo con contenedores de \textit{Podman} en Windows.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/multi-node_windows_\textit{Podman}_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores de \textit{Podman} (CPU) en entorno multinodo.}
    \label{fig:multi-node_windows_\textit{Podman}_time}
\end{figure}

En la tabla \ref{tab:multi-node_windows_\textit{Podman}} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
En la figura \ref{fig:multi-node_mac_\textit{Docker}_time} se muestra el tiempo de ejecución para la configuración de CPU en un entorno multinodo con contenedores de Mac.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/multi-node_mac_\textit{Docker}_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores de Mac (CPU) en entorno multinodo.}
    \label{fig:multi-node_mac_\textit{Docker}_time}
\end{figure}

En la tabla \ref{tab:multi-node_mac_\textit{Docker}} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
En la figura \ref{fig:multi-node_mac_\textit{Podman}_time} se muestra el tiempo de ejecución para la configuración de CPU en un entorno multinodo con contenedores de \textit{Podman} en Mac.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/multi-node_mac_\textit{Podman}_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores de \textit{Podman} (CPU) en entorno multinodo.}
    \label{fig:multi-node_mac_\textit{Podman}_time}
\end{figure}

En la tabla \ref{tab:multi-node_mac_\textit{Podman}} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
En la figura \ref{fig:thread_sweep_ubuntu_\textit{Docker}_time} se muestra el tiempo de ejecución para la configuración de CPU en un entorno con contenedores de Ubuntu.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/thread_sweep_ubuntu_\textit{Docker}_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores de Ubuntu (CPU).}
    \label{fig:thread_sweep_ubuntu_\textit{Docker}_time}
\end{figure}

En la tabla \ref{tab:thread_sweep_ubuntu_\textit{Docker}_time} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
En la figura \ref{fig:thread_sweep_ubuntu_\textit{Podman}_time} se muestra el tiempo de ejecución para la configuración de CPU en un entorno con contenedores de \textit{Podman}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/thread_sweep_ubuntu_\textit{Podman}_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores de \textit{Podman} (CPU).}
    \label{fig:thread_sweep_ubuntu_\textit{Podman}_time}
\end{figure}

En la tabla \ref{tab:thread_sweep_ubuntu_\textit{Podman}_time} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
En la figura \ref{fig:thread_sweep_ubuntu_\textit{Docker}_gpu_time} se muestra el tiempo de ejecución para la configuración de CPU + GPU en un entorno con contenedores de Ubuntu.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/thread_sweep_ubuntu_\textit{Docker}_gpu_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores de Ubuntu (CPU + GPU).}
    \label{fig:thread_sweep_ubuntu_\textit{Docker}_gpu_time}
\end{figure}

En la tabla \ref{tab:thread_sweep_ubuntu_\textit{Docker}_gpu_time} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
En la figura \ref{fig:thread_sweep_ubuntu_\textit{Podman}_gpu_time} se muestra el tiempo de ejecución para la configuración de CPU + GPU en un entorno con contenedores de \textit{Podman}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/thread_sweep_ubuntu_\textit{Podman}_gpu_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores de \textit{Podman} (CPU + GPU).}
    \label{fig:thread_sweep_ubuntu_\textit{Podman}_gpu_time}
\end{figure}

En la tabla \ref{tab:thread_sweep_ubuntu_\textit{Podman}_gpu_time} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
En la figura \ref{fig:thread_sweep_windows_\textit{Docker}_time} se muestra el tiempo de ejecución para la configuración de CPU en un entorno con contenedores de Windows.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/thread_sweep_windows_\textit{Docker}_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores \textit{Docker} de Windows (CPU).}
    \label{fig:thread_sweep_windows_\textit{Docker}_time}
\end{figure}

En la tabla \ref{tab:thread_sweep_windows_\textit{Docker}_time} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
En la figura \ref{fig:thread_sweep_windows_\textit{Podman}_time} se muestra el tiempo de ejecución para la configuración de CPU en un entorno con contenedores de \textit{Podman}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/thread_sweep_windows_\textit{Podman}_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores de \textit{Podman} (CPU).}
    \label{fig:thread_sweep_windows_\textit{Podman}_time}
\end{figure}

En la tabla \ref{tab:thread_sweep_windows_\textit{Podman}_time} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
En la figura \ref{fig:thread_sweep_mac_\textit{Docker}_time} se muestra el tiempo de ejecución para la configuración de CPU en un entorno con contenedores de Mac.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/thread_sweep_mac_\textit{Docker}_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores \textit{Docker} de Mac (CPU).}
    \label{fig:thread_sweep_mac_\textit{Docker}_time}
\end{figure}

En la tabla \ref{tab:thread_sweep_mac_\textit{Docker}_time} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
...
En la figura \ref{fig:thread_sweep_mac_\textit{Podman}_time} se muestra el tiempo de ejecución para la configuración de CPU en un entorno con contenedores de \textit{Podman}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/cap5/thread_sweep_mac_\textit{Podman}_time.png}
    \caption{Tiempo de ejecución en función del número de hebras en contenedores de \textit{Podman} (CPU).}
    \label{fig:thread_sweep_mac_\textit{Podman}_time}
\end{figure}

En la tabla \ref{tab:thread_sweep_mac_\textit{Podman}_time} se presentan los tiempos de ejecución y la reducción porcentual respecto a una hebra.
